...
# Exclude those aged under 40 (HbA1c >= 7.5%)
...
nrow(data_excluded) # 171
## Weighted
svytable(~eligible, NHANES_svy) # FALSE/TRUE = 5733797.652/3600954.398 
...
### Excluded
table(data_excluded$RIAGENDR, exclude = NULL) #1/2 = 90/81
...
### Excluded
table(data_excluded$A4_weak_cvd, exclude = NULL) #0/1 = 131/40
...
### Excluded
table(data_excluded$CHD_history, exclude = NULL) #0/1 = 150/21
...
### Excluded
table(data_excluded$isr_cat, exclude = NULL) #1/2 = 32/139
...
### Excluded
table(data_excluded$medicaid_cat, exclude = NULL) #1/2 = 29/142
...
# save as a csv file
write.csv(chr_tbl, paste0(path_to_output,"characteristics_a1c7.5_20240115.csv"))
write.csv(race_tbl, paste0(path_to_output,"race_a1c7.5_20240115.csv"))
write.csv(edu_tbl, paste0(path_to_output,"edu_a1c7.5_20240115.csv"))
write.csv(srh_tbl, paste0(path_to_output,"srh_a1c7.5_20240115.csv"))
